...
- Open the repository root in your development tool. Read [AGENTS](AGENTS.md) → [PROJECT](PROJECT.md) → [ACTIVE](ACTIVE.md), then the relevant code and documents. M2.0 is complete; M2.1 is in progress. PostgreSQL job records are connected; crash recovery comes next.
